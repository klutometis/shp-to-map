# -*- org -*-
* TODO Produce envelope-geometries given pipe-delimited hexes.
  #+BEGIN_SRC java :tangle envelope-geometries.bsh :shebang #!/usr/bin/env bsh
    ...
    // POINT (-75.9773377 38.6815049)
    // POINT (-84.3575958 32.7126383)
    print(toEnvelopeGeometries("0101000020E610000077A96CB38CFE52C029C8748D3B574340|0101000020E6100000F78B7ED9E21655C0433058BB375B4040").equals(new LinkedList() {
            {
    ...
    print(envelopeGeometries.equals(envelopeGeometries));
